        ...
        <div class="row mt-4">
            ...
            <div class="card mb-4 mb-lg-0">
                <div class="card-header m-2">
                    ...
                    <form class="navbar-nav m-auto col-lg-3 " style="display:inline-block" method="GET" action="#">
                        @csrf
                            <div class="input-group">
                              <input type="text" name="search" value= "{{ Request::get('search') }}" class="form-control" style="border: None;" placeholder="Search for Job Post" aria-label="Search" aria-describedby="search-addon"/>
